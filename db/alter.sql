...
alter table peerages rename column "Time" to time;
...
alter table ranks rename column "Sex" to gender;
...
alter table law_lords rename column "Jurisdiction" to jurisdiction;
